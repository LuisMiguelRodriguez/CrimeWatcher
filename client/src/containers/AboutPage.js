    ...
    <div className="container-fluid"> 
      ...
      <div className="row biorow">
        ...
        <div className="col-md-8 col-md-offset-2">
          <h4>Project Manager/FrontEnd Designer</h4>
          <h4>Jen</h4>
          <p> She is a freelance marketing strategist based in Southern California who specializes in eCommerce and entrepreneurship. She's passionate about helping businesses finding untapped resources in their communication plans.
          </p>
        </div>
      </div>
      <div className="row biorow">
